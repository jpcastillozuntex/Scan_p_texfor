...
namespace Scan_P_texfor
{
  public class Cajas03 : Form
  {
    ...
    internal virtual ComboBox cajan
    {
      get
      {
        return this._cajan;
      ...
      [MethodImpl(MethodImplOptions.Synchronized)] set
      {
        KeyPressEventHandler pressEventHandler = new KeyPressEventHandler(this.cajan_KeyPress);
        ComboBox cajan1 = this._cajan;
        if (cajan1 != null)
          cajan1.KeyPress -= pressEventHandler;
        this._cajan = value;
        ComboBox cajan2 = this._cajan;
        if (cajan2 == null)
          return;
        cajan2.KeyPress += pressEventHandler;
      }
    }
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Cajas03));
      ...
      this.ToolTip1.SetToolTip((Control) this.corte, "Corte.");
      ...
      this.cajan.BackColor = Color.FromArgb((int) byte.MaxValue, (int) byte.MaxValue, 128);
      this.cajan.Font = new Font("Microsoft Sans Serif", 12f, FontStyle.Regular, GraphicsUnit.Point, (byte) 0);
      this.cajan.Items.AddRange(new object[3]
      {
        (object) "JT",
        (object) "TRECENTO",
        (object) "ZUNTEX"
      });
      this.cajan.Location = new Point(199, 31);
      this.cajan.Name = "cajan";
      this.cajan.Size = new Size(189, 28);
      this.cajan.TabIndex = 5;
      this.ToolTip1.SetToolTip((Control) this.cajan, "Tipo de Prenda");
      ...
      this.fg.Location = new Point(23, 335);
      this.fg.Name = "fg";
      this.fg.Rows.DefaultSize = 21;
      this.fg.Size = new Size(980, 326);
      ...
      this.GroupBox1.Size = new Size(468, 256);
      ...
      this.Label11.Location = new Point(6, 210);
      ...
      this.GroupBox2.Controls.Add((Control) this.cajan);
      ...
      this.GroupBox2.Size = new Size(486, 256);
      this.GroupBox2.TabIndex = 102;
      this.GroupBox2.TabStop = false;
      this.GroupBox2.Text = "Caja que Recibe";
      ...
      this.CheckBox1.Font = new Font("Microsoft Sans Serif", 9.75f, FontStyle.Bold, GraphicsUnit.Point, (byte) 0);
      this.CheckBox1.Location = new Point(517, 26);
      this.CheckBox1.Name = "CheckBox1";
      this.CheckBox1.Size = new Size(179, 20);
      this.CheckBox1.TabIndex = 99;
      this.CheckBox1.Text = "Crear una Caja Nueva";
      ...
      this.ClientSize = new Size(1024, 696);
      ...
      this.Name = nameof (Cajas03);
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Traslado de unidades entre Cajas";
      this.fg.EndInit();
    ...
    private void Cortes_status(object sender, EventArgs e)
    {
      ...
      this.cajan.KeyPress += new KeyPressEventHandler(this.keypressed4);
      this.unidn.KeyPress += new KeyPressEventHandler(this.keypressed5);
      ComboBox cajan = this.cajan;
      Module1.llena_combos(ref cajan, "SELECT * FROM TIPOS_PRENDA", "TIPO_PRENDA");
      this.cajan = cajan;
    ...
    private void llena_corte()
    {
      ...
      Module1.llena_combos(ref cajad, "SELECT DISTINCT CAJA FROM CAJAS04 WHERE CORTE = '" + this.corte.Text + "'ORDER BY CAJA", "CAJA");
      this.cajad = cajad;
      if (this.co.Rows.Count > 0)
      {
        ...
        try
        {
          this.seccion = Conversions.ToString(this.dr["SECCION"]);
        }
        catch (Exception ex)
        {
    ...
    private void keypressed4(object o, KeyPressEventArgs e)
    {
      if (e.KeyChar != '\r')
        return;
      e.Handled = true;
      if ((uint) Microsoft.VisualBasic.CompilerServices.Operators.CompareString(Strings.Trim(this.cajan.Text), "", false) > 0U)
        this.unidn.Focus();
    }
    ...
    {
      ComboBox cajan = this.cajan;
      Module1.AutoCompletar(ref cajan, e);
      this.cajan = cajan;
    }
    ...
    private void cajad_SelectedIndexChanged(object sender, EventArgs e)
    {
      ...
      {
        ComboBox cajan = this.cajan;
        Module1.llena_combos(ref cajan, "SELECT DISTINCT CAJA FROM CAJAS04 WHERE CORTE = '" + this.corte.Text + "' AND CAJA <> '" + this.cajad.Text + "' ORDER BY CAJA", "CAJA");
        this.cajan = cajan;
      }
      else
      {
        this.cajan.Items.Clear();
        this.cajan.Items.Add((object) "NUEVA");
        this.cajan.SelectedIndex = 0;
      }
    }
    ...
    private void sigue_Click(object sender, EventArgs e)
    {
      ...
      else if (Microsoft.VisualBasic.CompilerServices.Operators.CompareString(this.cajad.Text, this.cajan.Text, false) == 0)
      {
        int num3 = (int) Interaction.MsgBox((object) "No puede hacer traslados dentro de la misma caja. ", MsgBoxStyle.Critical, (object) "Por favor revise !!!");
      }
      else
      {
        this.tipo_seg = this.tipo_segunda(this.cajad.Text, this.tipod.Text, this.tallad.Text);
        bool ok;
        this.agrega_fg(ref ok);
        if (!ok)
        {
          int num4 = (int) Interaction.MsgBox((object) "No pueden haber dos registros dentro una misma Caja con Talla y Tipo de Segunda repetidos.", MsgBoxStyle.Critical, (object) "Por favor revise !!!");
        }
        else
        {
          ref DataTable local1 = ref this.co;
          ...
          int num5 = cajas_01.modifica_caja(ref local1, text1, text2, text3, integer1, ref local2, ref local3) ? 1 : 0;
    ...
    private string tipo_segunda(string caja, string tipo, string talla)
    {
      DataRow[] dataRowArray = this.co.Select("CAJA = '" + caja + "' AND TIPO = '" + tipo + "' AND TALLA = '" + talla + "'");
      if (dataRowArray.Length > 0)
      {
        DataRow dataRow = dataRowArray[0];
        this.seccion = Conversions.ToString(dataRow["SECCION"]);
        this.tipo_seg = Conversions.ToString(dataRow["TIPO_SEG"]);
      }
    ...
    {
      ok = true;
      if (this.fg.FindRow((object) (this.cajad.Text + this.tallad.Text + this.cajan.Text), 1, 0, false) > -1)
      {
        ok = false;
      }
      else
      {
        ...
        this.fg[index, 0] = (object) (this.cajad.Text + this.tallad.Text + this.cajan.Text);
    ...
    private void graba_datos()
    {
      ...
      if (this.CheckBox1.Checked)
      {
        jap.crea_cajas((object) empresas, this.cnn, ref this.caja_nueva);
        int num = checked (this.fg.Rows.Count - 1);
        int index = 1;
        while (index <= num)
        {
          this.fg[index, 5] = (object) this.caja_nueva;
          checked { ++index; }
        }
      }
      this.cnn.Open();
      ...
      try
      {
        ...
        while (index <= num1)
        {
          string str1 = "CONVERT(DATETIME,'" + Strings.Format(RuntimeHelpers.GetObjectValue(this.fg[index, 9]), "yyyy-MM-dd HH:mm:ss") + "')";
          string str2 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS01 SET UNIDADES = UNIDADES + '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 5]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str2;
          int num2;
          if (command.ExecuteNonQuery() == 0)
          {
            string str3 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "INSERT INTO CAJAS01 (CAJA,CORTE,TALLA,TIPO,UNIDADES,CLIENTE,UBICACION,FECHA,ESTADO,ESCALA,ORDEN,IMPRESO,TIPO_SEG,SECCION) VALUES ('", this.fg[index, 5]), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), this.fg[index, 2]), (object) "','"), this.fg[index, 6]), (object) "','"), (object) this.cliente), (object) "','00',"), (object) str1), (object) ",'P','"), (object) this.escala), (object) "','"), this.fg[index, 7]), (object) "','"), (object) empresas.usuario), (object) "','"), this.fg[index, 8]), (object) "','"), (object) this.seccion), (object) "')"));
            command.CommandText = str3;
            num2 = command.ExecuteNonQuery();
          }
          string str4 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS04 SET UNIDADES = UNIDADES + '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 5]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str4;
          if (command.ExecuteNonQuery() == 0)
          {
            string str3 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "INSERT INTO CAJAS04 (CAJA,CORTE,TALLA,TIPO,UNIDADES,FECHA,QUIEN) VALUES ('", this.fg[index, 5]), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), this.fg[index, 2]), (object) "','"), this.fg[index, 6]), (object) "',"), (object) str1), (object) ",'"), (object) empresas.usuario), (object) "')"));
            command.CommandText = str3;
            num2 = command.ExecuteNonQuery();
          }
          string str5 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS01 SET UNIDADES = UNIDADES - '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 1]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str5;
          num2 = command.ExecuteNonQuery();
          string str6 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS04 SET UNIDADES = UNIDADES - '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 1]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str6;
          num2 = command.ExecuteNonQuery();
          string str7 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "INSERT INTO CAJAS03 (TIPO,CAJA_D,CORTE_D,TALLA_D,TIPO_D,CAJA_A,CORTE_A,TALLA_A,TIPO_A,UNIDADES,FECHA,QUIEN,ORDEN) VALUES ('C','", this.fg[index, 1]), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), this.fg[index, 2]), (object) "','"), this.fg[index, 5]), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), (object) this.tipod.Text), (object) "','"), this.fg[index, 6]), (object) "',GETDATE(),'"), (object) empresas.usuario), (object) "','"), this.fg[index, 7]), (object) "')"));
          ...
          if (Strings.InStr(1, this.caja_nueva, Conversions.ToString(this.fg[index, 5]), CompareMethod.Binary) == 0)
            this.caja_nueva = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.AddObject((object) this.caja_nueva, this.fg[index, 5]));
          checked { ++index; }
        }
    ...
    private void CheckBox1_CheckedChanged(object sender, EventArgs e)
    {
      ...
      else
      {
        this.fg.Rows.Count = 1;
        ComboBox cajan = this.cajan;
        Module1.llena_combos(ref cajan, "SELECT DISTINCT CAJA FROM CAJAS01 WHERE CORTE = '" + this.corte.Text + "' AND CAJA <> '" + this.cajad.Text + "' ORDER BY CAJA", "CAJA");
        this.cajan = cajan;
      }
    }
  }
