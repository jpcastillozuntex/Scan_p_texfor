...
namespace Scan_P_texfor
{
  public class Cajas02_c : Form
  {
    ...
    private void InitializeComponent()
    {
      ...
      ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof (Cajas02_c));
      ...
      this.Name = nameof (Cajas02_c);
      this.ShowInTaskbar = false;
      this.StartPosition = FormStartPosition.CenterScreen;
      this.Text = "Segundas a Primeras";
      this.fg.EndInit();
    ...
    private void Cortes_status(object sender, EventArgs e)
    {
      ...
      this.tipod.Items.Clear();
      this.tipon.Items.Add((object) "Primeras");
    ...
    private void setea_fg()
    {
      ...
      Module1.llena_combos(ref corte, "SELECT DISTINCT CORTE FROM CAJAS01 WHERE ESTADO IN ('A','P') AND TIPO_SEG > 0  ORDER BY CORTE", "CORTE");
      this.corte = corte;
    }
    ...
    private void llena_corte()
    {
      ...
      Module1.llena_combos(ref cajad, "SELECT DISTINCT CAJA FROM CAJAS01 WHERE CORTE = '" + this.corte.Text + "' AND UNIDADES > 0 AND TIPO_SEG > 0 ORDER BY CAJA", "CAJA");
      this.cajad = cajad;
    ...
    private void agrega_fg(ref bool ok)
    {
      ...
      else
      {
        ...
        int num = this.revisa_caja_talla(this.cajad.Text, this.tallad.Text, Conversions.ToInteger(this.unid.Text));
        this.fg[index, 10] = (object) num;
        ...
        this.fg[index, 9] = (object) (this.cajad.Text + this.tallad.Text);
      }
    }

    private int revisa_caja_talla(string caja, string talla, int uni)
    {
      int row = this.fg.FindRow((object) (caja + talla), 1, 9, false);
      return row != -1 ? Conversions.ToInteger(this.fg[row, 10]) : uni;
    }
    ...
    private void graba_datos()
    {
      ...
      try
      {
        ...
        while (index <= num1)
        {
          ...
          string str1 = "P";
          string str2 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS01 SET UNIDADES = UNIDADES + '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), (object) caja), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), (object) str1), (object) "'"));
          command.CommandText = str2;
          int num3 = command.ExecuteNonQuery();
          string str3 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS04 SET UNIDADES = UNIDADES + '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), (object) caja), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), (object) str1), (object) "'"));
          command.CommandText = str3;
          if (command.ExecuteNonQuery() == 0)
          {
            string str4 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("INSERT INTO CAJAS01 (CAJA,CORTE,TALLA,TIPO,UNIDADES,CLIENTE,UBICACION,FECHA,ESTADO,ESCALA,ORDEN,IMPRESO,TIPO_SEG,SECCION) VALUES ('" + caja + "','" + this.corte.Text + "','"), this.fg[index, 3]), (object) "','"), (object) str1), (object) "','"), this.fg[index, 6]), (object) "','"), (object) this.cliente), (object) "','00','"), this.fg[index, 8]), (object) "','P','"), (object) this.escala), (object) "','"), this.fg[index, 7]), (object) "','"), (object) empresas.usuario), (object) "','"), (object) num2), (object) "','"), (object) this.seccion), (object) "')"));
            command.CommandText = str4;
            int num4 = command.ExecuteNonQuery();
            try
            {
              string str5 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) ("INSERT INTO CAJAS04 (CAJA,CORTE,TALLA,TIPO,UNIDADES,FECHA ,QUIEN) VALUES ( '" + caja + "','" + this.corte.Text + "','"), this.fg[index, 3]), (object) "','"), (object) str1), (object) "','"), this.fg[index, 6]), (object) "','"), this.fg[index, 8]), (object) "','"), (object) empresas.usuario), (object) "')"));
          ...
          string str6 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS01 SET UNIDADES = UNIDADES - '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 1]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str6;
          num3 = command.ExecuteNonQuery();
          string str7 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "UPDATE CAJAS04 SET UNIDADES = UNIDADES - '", this.fg[index, 6]), (object) "' WHERE CAJA = '"), this.fg[index, 1]), (object) "' AND CORTE = '"), (object) this.corte.Text), (object) "' AND TALLA = '"), this.fg[index, 3]), (object) "' AND TIPO = '"), this.fg[index, 2]), (object) "'"));
          command.CommandText = str7;
          num3 = command.ExecuteNonQuery();
          string str8 = Conversions.ToString(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject(Microsoft.VisualBasic.CompilerServices.Operators.ConcatenateObject((object) "INSERT INTO CAJAS03 (TIPO,CAJA_D,CORTE_D,TALLA_D,TIPO_D,CAJA_A,CORTE_A,TALLA_A,TIPO_A,TIPO_SEG,UNIDADES,FECHA,QUIEN,ORDEN) VALUES ('S','", this.fg[index, 1]), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), this.fg[index, 2]), (object) "','"), (object) caja), (object) "','"), (object) this.corte.Text), (object) "','"), this.fg[index, 3]), (object) "','"), (object) str1), (object) "','"), (object) num2), (object) "','"), this.fg[index, 6]), (object) "',GETDATE(),'"), (object) empresas.usuario), (object) "','"), this.fg[index, 7]), (object) "')"));
        ...
        int num5 = (int) Interaction.MsgBox((object) "Grabacion Exitosa", MsgBoxStyle.Exclamation, (object) "Grabaciones");
      }
      catch (Exception ex1)
      {
        ...
        try
        {
          int num = (int) Interaction.MsgBox((object) ("Inconsistencia en Datos\n" + exception.Message), MsgBoxStyle.Critical, (object) "Por favor avise a Jesús Acosta !!!!");
